...
export class GPU {
     ...
     */
    get cables() {
        const ret = wasm.__wbg_get_gpu_cables(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
    ...
    get generation() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_gpu_generation(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
    ...
    get name() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.__wbg_get_gpu_name(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
            return getStringFromWasm0(ret[0], ret[1]);
        } finally {
     ...
     */
    get pcie() {
        const ret = wasm.__wbg_get_gpu_pcie(this.__wbg_ptr);
        let v1;
        if (ret[0] !== 0) {
            v1 = getStringFromWasm0(ret[0], ret[1]).slice();
            wasm.__wbindgen_free(ret[0], ret[1] * 1, 1);
     ...
     */
    get vram() {
        const ret = wasm.__wbg_get_gpu_vram(this.__wbg_ptr);
     ...
     */
    get year() {
        const ret = wasm.__wbg_get_gpu_year(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {GPU}
    ...
    set cables(arg0) {
        ...
        wasm.__wbg_set_gpu_cables(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {string} arg0
     */
    set generation(arg0) {
        const ptr0 = passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_gpu_generation(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {number} arg0
     */
    ...
    set name(arg0) {
        const ptr0 = passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_gpu_name(this.__wbg_ptr, ptr0, len0);
    }
    /**
     * @param {string | null} [arg0]
     */
    set pcie(arg0) {
        var ptr0 = isLikeNone(arg0) ? 0 : passStringToWasm0(arg0, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        var len0 = WASM_VECTOR_LEN;
        wasm.__wbg_set_gpu_pcie(this.__wbg_ptr, ptr0, len0);
    }
    /**
     ...
     */
    set vram(arg0) {
        wasm.__wbg_set_gpu_vram(this.__wbg_ptr, isLikeNone(arg0) ? 0x100000001 : Math.fround(arg0));
    }
    /**
     * @param {number} arg0
     */
    set year(arg0) {
        wasm.__wbg_set_gpu_year(this.__wbg_ptr, arg0);
    }
}
 ...
 * @returns {any}
 */
export function check_answer(id) {
    const ret = wasm.check_answer(id);
    if (ret[2]) {
...
export function generate_database() {
    const ret = wasm.generate_database();
    return ret;
}
...
export function get_results(query, already_guessed) {
    ...
    const ret = wasm.get_results(ptr0, len0, ptr1, len1);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
        ...
        __wbg_new_typed_323f37fd55ab048d: function(arg0, arg1) {
            try {
                ...
                var cb0 = (arg0, arg1) => {
                    ...
                    state0.a = 0;
                    try {
                        return wasm_bindgen__convert__closures_____invoke__h13e336c3c5842ed0(a, state0.b, arg0, arg1);
                    } finally {
                        state0.a = a;
                    }
                };
...
function wasm_bindgen__convert__closures_____invoke__hb3550f2479346a73(arg0, arg1, arg2) {
    const ret = wasm.wasm_bindgen__convert__closures_____invoke__hb3550f2479346a73(arg0, arg1, arg2);
    if (ret[1]) {
        throw takeFromExternrefTable0(ret[0]);
    }
}

function wasm_bindgen__convert__closures_____invoke__h13e336c3c5842ed0(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures_____invoke__h13e336c3c5842ed0(arg0, arg1, arg2, arg3);
}
